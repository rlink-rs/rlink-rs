...
//! Generated file by schema checkpoint_data, version 1.3.1
...
pub const FIELD_NAME: [&'static str; 3] = [
    // 0: ts
    "ts",
    // 1: app
    "app",
...
pub const FIELD_METADATA: FieldMetadata<3> = FieldMetadata::new(&FIELD_TYPE, &FIELD_NAME);
